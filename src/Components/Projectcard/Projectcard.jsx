    ...
    <Animation>
      ...
      >
        <div className='h-full flex flex-col justify-between opacity-0 group-hover:opacity-100 transition-opacity duration-500'>
          ...
          <div 
            className={`min-h-[30vh] flex justify-end items-end bg-gradient-to-t ${cn2} pb-10 px-8 rounded-b-3xl text-center max-sm:h-[20vh] max-sm:pb-6 max-sm:px-4 max-sm:overflow-hidden max-lg:min-h-[20vh] max-lg:pb-8 max-lg:px-6 max-lg:overflow-hidden ${cn2}`}
          >
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
